...
public class ErrorMessage {
    ...
    public static final String CCCD_IN_USE = "CCCD is already in use.";
    ...
    public static final String EMPTY_STOCK = "Stock cannot be empty";
    public static final String EMPTY_SIZE = "Size cannot be empty";
    public static final String EMPTY_COLOR = "Color cannot be empty";
